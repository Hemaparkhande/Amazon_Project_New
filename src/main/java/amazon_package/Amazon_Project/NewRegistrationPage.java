...
//	WebElement changecountrycode_button;
	...
	/*public void changecountrycode(WebDriver driver)
	{
		wait.until(ExpectedConditions.elementToBeClickable(changecountrycode_button));
//		Select code = new Select (changecountrycode_button);
//		code.deselectByValue("CH +41");
		changecountrycode_button.click();
	}*/
